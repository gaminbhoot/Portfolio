    ...
    <AnimatePresence onExitComplete={handleExitComplete}>
      {visible && (
        ...
        >
          ...
          >
            <defs>
              <mask id="jay-sig-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="600" height="600">
                <rect width="600" height="600" fill="black" />
                
                {/* Stroke 0: Top loop flourish */}
                <motion.path
                  d="M 230 360 C 270 330 330 300 400 280 L 460 270"
                  fill="none"
                  stroke="white"
                  strokeWidth="60"
                  strokeLinecap="round"
                ...
                {/* Stroke 1: J main body down and sweeping loop */}
                <motion.path
                  d="M 316 300 C 310 320 280 400 150 480 C 60 540 10 560 15 575 C 25 590 60 580 120 540 C 200 480 270 380 316 300 C 330 270 360 270 410 380"
                  fill="none"
                  stroke="white"
                  strokeWidth="70"
                  strokeLinecap="round"
                ...
                {/* Stroke 2: letter a */}
                <motion.path
                  d="M 400 390 C 420 360 450 360 460 380 C 470 400 450 430 420 420 C 400 410 420 380 460 380 L 460 425 C 465 425 480 410 495 385"
                  fill="none"
                  stroke="white"
                  strokeWidth="60"
                  strokeLinecap="round"
                  ...
                  initial={{ pathLength: 0 }}
                  animate={{ pathLength: 1 }}
                  transition={{ duration: 0.5, ease: [0.65, 0, 0.35, 1], delay: 0.85 }}
                />

                {/* Stroke 3: letter y with descender tail */}
                <motion.path
                  d="M 490 385 C 500 370 520 370 535 390 C 545 405 550 400 555 380 L 550 430 C 530 480 500 560 515 580 C 530 590 550 550 560 490 C 570 430 590 400 600 390"
                  fill="none"
                  stroke="white"
                  strokeWidth="60"
                  strokeLinecap="round"
